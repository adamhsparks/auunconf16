...
# to save space
writeRaster(cfiles, filename = "GTif/AWAP", format = "GTiff",
...
download Oztralia, level 2 data from the [GADM database of Global Administrative Areas](http://gadm.org).
...
library(raster)
Oz <- getData(name = "GADM", download = TRUE, country = "Oz", level = 2)

# Subset Oztralia data to QLD
QLD <- Oz[Oz@data$NAME_1 == "Queensland", ]

```

Crop, mask and plot the raster stack using Oztralia
```{r, echo = TRUE, warning = FALSE, eval = TRUE, error = FALSE}
